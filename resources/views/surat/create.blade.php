    ...
    <div class="card shadow mb-4">
      ...
      <div class="collapse show" id="collapseCardExample1">
        <div class="card-body">
          ...
          <div class="col-md-9">
              <input id="no_surat" type="text" class="form-control @error('no_surat') is-invalid @enderror" name="no_surat" required autocomplete="no_surat" >
          ...
          <div class="col-md-9">
              <input id="no_agenda" type="text" class="form-control @error('no_agenda') is-invalid @enderror" name="no_agenda" required autocomplete="no_agenda" >
              <small id="help" class="form-text text-muted">Wajib Diisi
              </small>
              @error('no_agenda')
                  <span class="invalid-feedback" role="alert">
          ...
          <div class="col-md-5">
              <input id="datepicker7" type="text" class="form-control @error('tanggal_kirim') is-invalid @enderror" name="tanggal_kirim" required autocomplete="tanggal_kirim" >
              <small id="help" class="form-text text-muted">Wajib Diisi
              </small>
              @error('tanggal_kirim')
                  <span class="invalid-feedback" role="alert">
          ...
          <div class="col-md-5">
              <input id="datepicker6" type="text" class="form-control @error('tanggal_terima') is-invalid @enderror" name="tanggal_terima" autocomplete="tanggal_terima" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
          ...
          <div class="col-md-9">
              <input id="pengirim" type="text" class="form-control @error('pengirim') is-invalid @enderror" name="pengirim" autocomplete="pengirim" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('pengirim')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-9">
              <textarea id="perihal" type="text" class="form-control @error('perihal') is-invalid @enderror" name="perihal" autocomplete="perihal" ></textarea>
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('perihal')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-9">
              <input id="no_disposisi" type="text" class="form-control @error('no_disposisi') is-invalid @enderror" name="no_disposisi" autocomplete="no_disposisi" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('no_disposisi')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-9">
              <input id="no_berangkas" type="text" class="form-control @error('no_berangkas') is-invalid @enderror" name="no_berangkas" autocomplete="no_berangkas" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('no_berangkas')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-6">
              <input id="file" type="file" class="form-control @error('file') is-invalid @enderror" name="file" autocomplete="file" required>
