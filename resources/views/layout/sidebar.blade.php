<!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTa" aria-expanded="true" aria-controls="collapseTa">
          <i class="fas fa-fw fa-trash"></i>
          <span>Recylce Bin</span>
        </a>
        <div id="collapseTa" class="collapse" aria-labelledby="headingT" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Kelola Data:</h6>
            <a class="collapse-item" href="{{ route('recycle.index') }}">Surat</a>
            <a class="collapse-item" href="{{ route('recycle.pegawai') }}">Pegawai</a>
          </div>
        </div>
      </li>
