    ...
    <div class="card shadow mb-4">
      ...
      <div class="collapse show" id="collapseCardExample1">
        <div class="card-body">
          ...
          <div class="col-md-9">
              <input id="nip" type="text" class="form-control @error('nip') is-invalid @enderror" name="nip" required autocomplete="nip" >
          ...
          <div class="col-md-9">
              <input id="pangkat" type="text" class="form-control @error('pangkat') is-invalid @enderror" name="pangkat" autocomplete="pangkat" >
          ...
          <div class="col-md-9">
              <input id="jabatan" type="text" class="form-control @error('jabatan') is-invalid @enderror" name="jabatan" required autocomplete="jabatan" >
              <small id="help" class="form-text text-muted">Wajib Diisi
              </small>
              @error('jabatan')
                  <span class="invalid-feedback" role="alert">
          ...
          <div class="col-md-9">
              <input id="eselon" type="text" class="form-control @error('eselon') is-invalid @enderror" name="eselon" autocomplete="eselon" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('eselon')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-9">
              <input id="unit_kerja" type="text" class="form-control @error('unit_kerja') is-invalid @enderror" name="unit_kerja" autocomplete="unit_kerja" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('unit_kerja')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-9">
              <input id="masa_kerja" type="text" class="form-control @error('masa_kerja') is-invalid @enderror" name="masa_kerja" autocomplete="masa_kerja" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('masa_kerja')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-9">
              <input id="SK_CPNS" type="text" class="form-control @error('SK_CPNS') is-invalid @enderror" name="SK_CPNS" autocomplete="SK_CPNS" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('SK_CPNS')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-9">
              <input id="SK_PNS" type="text" class="form-control @error('SK_PNS') is-invalid @enderror" name="SK_PNS" autocomplete="SK_PNS" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('SK_PNS')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-9">
              <input id="gaji" type="text" class="form-control @error('gaji') is-invalid @enderror" name="gaji" autocomplete="gaji" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('gaji')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-9">
              <input id="datepicker1" type="text" class="form-control @error('sumpah') is-invalid @enderror" name="sumpah" autocomplete="sumpah" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('sumpah')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
    ...
    <div class="card shadow mb-4">
      ...
      <div class="collapse show" id="axe2">
        <div class="card-body">
          ...
          <div class="col-md-9">
              <input id="nama_lengkap" type="text" class="form-control @error('nama_lengkap') is-invalid @enderror" name="nama_lengkap" required autocomplete="nama_lengkap" >
              <small id="help" class="form-text text-muted">Wajib Diisi
              </small>
              @error('nama_lengkap')
                  <span class="invalid-feedback" role="alert">
          ...
          <div class="col-md-9">
              <input id="tempat_lahir" type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" name="tempat_lahir" autocomplete="tempat_lahir" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('tempat_lahir')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-9">
              <input id="datepicker2" type="text" class="form-control @error('tanggal_lahir') is-invalid @enderror" name="tanggal_lahir" autocomplete="tanggal_lahir" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('tanggal_lahir')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-9">
              <input id="no_hp" type="text" class="form-control @error('no_hp') is-invalid @enderror" name="no_hp" autocomplete="no_hp" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('no_hp')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-9">
              <input id="nama_ayah" type="text" class="form-control @error('nama_ayah') is-invalid @enderror" name="nama_ayah" autocomplete="nama_ayah" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('nama_ayah')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-9">
              <input id="nama_ibu" type="text" class="form-control @error('nama_ibu') is-invalid @enderror" name="nama_ibu" autocomplete="nama_ibu" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
              @error('nama_ibu')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <div class="col-md-9">
              <input id="status_perkawinan" type="text" class="form-control @error('status_perkawinan') is-invalid @enderror" name="status_perkawinan" autocomplete="status_perkawinan" >
              <small id="help" class="form-text text-muted">Wajib Diisi</small>
